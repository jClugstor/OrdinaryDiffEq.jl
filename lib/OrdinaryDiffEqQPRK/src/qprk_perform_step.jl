...
@muladd function perform_step!(integrator, ::QPRK98ConstantCache, repeat_step = false)
    ...
    k10 = f(
        uprev + dt * (b10_1 * k1 + b10_6 * k6 + b10_7 * k7 + b10_8 * k8 + b10_9 * k9),
        p, t + d10 * dt
    )
    k11 = f(
        uprev +
            dt * (
            b11_1 * k1 + b11_6 * k6 + b11_7 * k7 + b11_8 * k8 + b11_9 * k9
                + b11_10 * k10
        ),
        p,
        t + d11 * dt
    ...
    k12 = f(
        uprev +
            dt * (
            b12_1 * k1 + b12_6 * k6 + b12_7 * k7 + b12_8 * k8 + b12_9 * k9
    ...
    k13 = f(
        uprev +
            dt * (
            b13_1 * k1 + b13_6 * k6 + b13_7 * k7 + b13_8 * k8 + b13_9 * k9
    ...
    k14 = f(
        uprev +
            dt * (
            b14_1 * k1 + b14_6 * k6 + b14_7 * k7 + b14_8 * k8 + b14_9 * k9
    ...
    k15 = f(
        uprev +
            dt * (
            b15_1 * k1 + b15_6 * k6 + b15_7 * k7 + b15_8 * k8 + b15_9 * k9
    ...
    k16 = f(
        uprev +
            dt * (
            b16_1 * k1 + b16_6 * k6 + b16_7 * k7 + b16_8 * k8 + b16_9 * k9
    ...
    u = uprev +
        dt * (
        w1 * k1 + w8 * k8 + w9 * k9 + w10 * k10 + w11 * k11 + w12 * k12 +
            w13 * k13 + w14 * k14 + w15 * k15 + w16 * k16
    )

    if integrator.opts.adaptive
        utilde = dt * (
            ϵ1 * k1 + ϵ8 * k8 + ϵ9 * k9 + ϵ10 * k10 + ϵ11 * k11 + ϵ12 * k12 +
...
@muladd function perform_step!(integrator, cache::QPRK98Cache, repeat_step = false)
    ...
    T2 = constvalue(typeof(one(t)))
    @OnDemandTableauExtract QPRK98Tableau T T2
    (; fsalfirst, k2, k3, k4, k5, k6, k7, k8, k9, k10, k11, k12, k13, k14, k15, k16, k, stage_limiter!, step_limiter!, thread) = cache
